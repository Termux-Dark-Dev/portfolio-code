...
class ProjectWidgetMobile extends StatefulWidget {
  String projectName;
  String projectDesc;
  ...
  @override
  State<ProjectWidgetMobile> createState() => _ProjectWidgetMobileState(
...
class _ProjectWidgetMobileState extends State<ProjectWidgetMobile> {
  String projectName;
  String projectDesc;
  String assetName;
  String url;
  List<Widget> chipList;
  _ProjectWidgetMobileState(
      {required this.chipList,
      required this.projectDesc,
      required this.projectName,
      required this.assetName,
